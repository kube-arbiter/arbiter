...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=arbiter.k8s.com.cn, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("observabilityactionpolicies"):
	...
	case v1alpha1.SchemeGroupVersion.WithResource("scores"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Arbiter().V1alpha1().Scores().Informer()}, nil
