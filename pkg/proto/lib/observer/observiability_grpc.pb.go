...
func (c *serverClient) GetPluginName(ctx context.Context, in *GetPluginNameRequest, opts ...grpc.CallOption) (*GetPluginNameResponse, error) {
	out := new(GetPluginNameResponse)
	err := c.cc.Invoke(ctx, "/obi.v1.Server/GetPluginName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServerServer) GetPluginName(context.Context, *GetPluginNameRequest) (*GetPluginNameResponse, error) {
...
func _Server_GetPluginName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPluginNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServerServer).GetPluginName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/obi.v1.Server/GetPluginName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerServer).GetPluginName(ctx, req.(*GetPluginNameRequest))
	}
